...
function setting_html() {
    var hoge = [
        ...
        ["<br><br>　<span class='settingname'>受入良化牌 ※処理重め</span><br><div class='hr'></div>"],
        ...
        ["<br><br>　<span class='settingname'>有効牌と受入良化牌の表示順</span><br><div class='hr'></div>"],
...
function other_html() {
    var hoge = [
        ...
        [
            ...
            ["また処理速度をごまかすため、<span class='bline'>手牌に1つも使ってない色の牌は受入良化のツモ対象から外しています</span>のでご注意ください。"],
            ["※1223mと入力すると、単騎待ちの1種3枚が受入良化対象となるため2m以外の全てが対象となりますが、"],
